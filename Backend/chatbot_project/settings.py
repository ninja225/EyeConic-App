...
SECRET_KEY = 'django-insecure-9ex*e#l9*%p&+9wn=(ekcbal$a9gu$*qbjksjj=^tbu@m*zih#'
...
# Specifically allow the Flutter web dev server
CORS_ALLOWED_ORIGINS = [
    "http://localhost:51793",  # Flutter web dev server
    "http://127.0.0.1:51793",
]
...
# Media settings
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'chat_images')
